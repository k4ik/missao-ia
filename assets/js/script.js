...
const perguntas = [
  {
      enunciado: "Em um mundo onde a preocupação com o meio ambiente é prioridade, você é um estudante dedicado à causa da sustentabilidade. Ao sair da escola, você se depara com uma comunidade engajada em práticas sustentáveis, onde a reciclagem, o uso consciente da água e a energia renovável são parte do cotidiano. Qual sua reação inicial?",
      alternativas: [
          {
              texto: "Você se sente inspirado e se une a um grupo de ativistas locais para participar de ações de conscientização e limpeza do meio ambiente.",
              afirmacao: "Decidiu agir e contribuir para um mundo mais sustentável."
          },
          {
              ...
              afirmacao: "Decidiu investigar mais sobre sustentabilidade para incorporá-la em seu dia a dia."
          }
      ]
  },
  {
